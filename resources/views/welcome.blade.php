        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide relative">
                ...
                <div class="absolute inset-0">
                    <img src="{{ asset('images/Plastik4.jpg') }}" alt="Aimi Packaging Banner Utama"
                ...
                <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
                    <div class="max-w-2xl text-white pt-10">
                        <span
                            class="inline-block py-1 px-3 rounded-full bg-orange-600 text-white text-xs font-bold tracking-wide mb-4 uppercase shadow-md">
                            Official Marketplace
                        </span>
                        <h1
                            class="text-4xl md:text-6xl font-extrabold tracking-tight mb-4 leading-tight drop-shadow-lg">
                        ...
                        <p class="text-lg md:text-xl text-gray-100 mb-8 leading-relaxed drop-shadow-md">
                            Aimi Packaging hadir sebagai mitra bisnis Anda menyediakan Lakban, Bubble Mailer, dan
                            Plastik Wrap kualitas terbaik dengan harga pabrik.
                        </p>
                        <div class="flex gap-4">
                            <a href="#katalog"
                                class="px-8 py-3 bg-orange-600 hover:bg-orange-700 rounded-full font-bold transition shadow-lg transform hover:-translate-y-1">
                                Belanja Sekarang
                            </a>
                            <a href="{{ route('about') }}"
                                class="px-8 py-3 bg-transparent border-2 border-white hover:bg-white hover:text-gray-900 rounded-full font-bold transition transform hover:-translate-y-1">
                                Tentang Kami
                            </a>
                        </div>
                    </div>
            ...
            <div class="swiper-slide relative bg-gray-800">
                <div class="absolute inset-0">
                    ...
                    <div
                        class="w-full h-full bg-gradient-to-br from-blue-900 to-gray-900 flex items-center justify-center">
                        {{-- Jika ada gambar promo: <img src="..." class="w-full h-full object-cover"> --}}
                    </div>
                </div>
                <div
                    class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-center text-center">
                    <div class="max-w-3xl text-white">
                        <span class="text-orange-400 font-bold tracking-widest uppercase mb-2 block">Promo Bulan
                            Ini</span>
                        <h2 class="text-4xl md:text-6xl font-extrabold mb-6">Diskon Spesial Grosir <br> Hingga 20%</h2>
                        <p class="text-xl mb-8 text-gray-300">Dapatkan harga khusus untuk pembelian Lakban Bening dalam
                            jumlah besar. Stok terbatas!</p>
                        <a href="#katalog"
                            class="inline-block px-8 py-4 bg-white text-gray-900 rounded-full font-bold hover:bg-gray-100 transition shadow-xl">
                            Lihat Produk Promo
                        </a>
                    </div>
                </div>
            ...
            <div class="swiper-slide relative">
                <div class="absolute inset-0">
                    <img src="{{ asset('images/perusahaan.jpg') }}" alt="Gudang Aimi"
                        class="w-full h-full object-cover">
                ...
                <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
                    <div class="max-w-2xl text-white ml-auto text-right">
                        ...
                        <p class="text-lg text-gray-200 mb-6">
                            Kami memastikan setiap produk dikemas dengan standar tinggi dan dikirim tepat waktu ke
                            seluruh wilayah Indonesia.
                        </p>
                        <a href="https://wa.me/6282132257239" target="_blank"
                            class="inline-flex items-center gap-2 text-orange-400 hover:text-orange-300 font-bold text-lg">
                            Hubungi Admin Logistik <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
...
<section class="py-16 bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
            ...
            <div class="p-4 group">
                <div
                    class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-orange-50 text-orange-500 mb-4 group-hover:bg-orange-500 group-hover:text-white transition duration-300">
                ...
                <p class="text-sm text-gray-500 px-4">Produk kami melalui quality control ketat untuk memastikan
                    kekuatan dan daya tahan maksimal.</p>
            </div>
            <div class="p-4 group">
                <div
                    class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-orange-50 text-orange-500 mb-4 group-hover:bg-orange-500 group-hover:text-white transition duration-300">
                ...
                <p class="text-sm text-gray-500 px-4">Dapatkan harga tangan pertama yang sangat kompetitif untuk
                    pembelian grosir maupun eceran.</p>
            </div>
            <div class="p-4 group">
                <div
                    class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-orange-50 text-orange-500 mb-4 group-hover:bg-orange-500 group-hover:text-white transition duration-300">
                ...
                <p class="text-sm text-gray-500 px-4">Proses pesanan yang cepat dan pengiriman aman ke seluruh wilayah
                    Indonesia.</p>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-col lg:flex-row items-center gap-12">
            <div class="lg:w-1/2 relative">
                <div class="aspect-w-4 aspect-h-3 rounded-2xl overflow-hidden shadow-xl bg-gray-100">
                    <img src="{{ asset('images/perusahaan.jpg') }}" alt="Gudang Stok Aimi Plastik"
                        class="object-cover w-full h-full transform hover:scale-105 transition duration-500">
                </div>
                <div
                    class="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-50 max-w-xs hidden md:block">
            ...
            <div class="lg:w-1/2">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 mt-2 mb-6">Mitra Solusi Kemasan Terpercaya
                    Sejak 2020</h2>

                <p class="text-gray-600 text-lg leading-relaxed mb-6">
                    PT. Aimi Plastik Indonesia berdedikasi untuk menyediakan perlengkapan packing berkualitas tinggi
                    bagi UMKM hingga industri besar di seluruh Indonesia.
                </p>

                <p class="text-gray-600 text-lg leading-relaxed mb-8">
                    Visi kami adalah menjadi pemimpin pasar yang mengutamakan inovasi dan kepuasan pelanggan melalui
                    produk yang presisi dan pelayanan prima.
                </p>

                <a href="{{ route('about') }}"
                    class="inline-flex items-center text-orange-600 font-bold hover:text-orange-700 transition group">
                    Baca Profil Lengkap
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="col-span-4 text-center py-16 bg-white rounded-3xl border-2 border-dashed border-gray-200">
                <div
                    class="inline-flex items-center justify-center w-20 h-20 bg-gray-100 rounded-full mb-4 text-gray-400">
...
<section class="py-20 bg-orange-50">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <a href="{{ route('artikel.index') }}" class="inline-block mt-4 text-orange-600 font-bold hover:underline">
                Lihat Semua Artikel →
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <article class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition">
                <div class="h-48 bg-gray-200 relative group">
                    <a href="{{ route('artikel.show', $news->id) }}" class="block w-full h-full">
                        @if($news->image)
                ...
                <div class="p-6">
                    ...
                    <h3 class="mt-2 text-xl font-bold text-gray-900 hover:text-orange-600 cursor-pointer line-clamp-2">
                        <a href="{{ route('artikel.show', $news->id) }}">{{ $news->title }}</a>
                    </h3>
                    ...
                    <a href="{{ route('artikel.show', $news->id) }}"
                        class="mt-4 inline-block text-sm font-semibold text-orange-600 hover:text-orange-700">Baca
                        Selengkapnya →</a>
                </div>
            </article>
            @empty
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16">
            <div class="space-y-10">
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed mb-8">
                        Kami berkomitmen memberikan pelayanan terbaik. Jangan ragu menghubungi tim kami untuk konsultasi
                        produk, penawaran harga grosir, atau bantuan teknis lainnya.
                    </p>

                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            <div
                                class="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center shrink-0 text-orange-600 mt-1">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Jl. Legundi Business Park H 08-09, Jl. Karangandong No.58,
                                    Dusun Banjarsari, Banjaran, Driyorejo, Gresik Regency, East Java 61177</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <a href="mailto:aimipacking45@gmail.com"
                                    class="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg hover:border-blue-500 hover:text-blue-500 transition shadow-sm group">
                                    <svg class="w-5 h-5 text-gray-500 group-hover:text-blue-500" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <a href="https://wa.me/6282132257239" target="_blank"
                                    class="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg hover:border-green-500 hover:text-green-500 transition shadow-sm group">
                                    <svg class="w-5 h-5 text-green-600 group-hover:text-green-700" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <path
                ...
                <div class="border-t border-gray-100 pt-8">
                    ...
                    <div class="flex gap-4 mb-8 grayscale hover:grayscale-0 transition duration-300">
                        <div
                            class="h-10 w-20 bg-white border border-gray-200 rounded flex items-center justify-center font-bold text-blue-700 italic">
                            JNE</div>
                        <div
                            class="h-10 w-20 bg-white border border-gray-200 rounded flex items-center justify-center font-bold text-red-600">
                            J&T</div>
                        <div
                            class="h-10 w-20 bg-white border border-gray-200 rounded flex items-center justify-center font-bold text-orange-500">
                            SPX</div>
                    </div>
                    ...
                    <div class="flex gap-4 grayscale hover:grayscale-0 transition duration-300">
                        <div
                            class="h-10 w-20 bg-white border border-gray-200 rounded flex items-center justify-center font-bold text-blue-800">
                            BCA</div>
                        <div
                            class="h-10 w-20 bg-white border border-gray-200 rounded flex items-center justify-center font-bold text-orange-600">
                            BNI</div>
                        <div
                            class="h-10 w-20 bg-white border border-gray-200 rounded flex items-center justify-center font-bold text-blue-600">
                            BRI</div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-6">
                <div
                    class="h-full min-h-100 w-full bg-gray-200 rounded-3xl overflow-hidden shadow-xl border border-gray-100 relative">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d23260.96283539689!2d112.56989777843683!3d-7.351839194096372!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e78090070c1c3d5%3A0x1ed6e7c3668ae23d!2sPT.%20Aimi%20Plastik%20Indonesia!5e0!3m2!1sen!2sid!4v1766849888941!5m2!1sen!2sid"
                        width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    <div class="absolute bottom-6 left-6 right-6">
                        <a href="https://wa.me/6282132257239" target="_blank"
                            class="block w-full bg-white/90 backdrop-blur text-gray-900 py-4 rounded-xl font-bold text-center shadow-lg hover:bg-orange-500 hover:text-white transition duration-300 border border-gray-200">
                            Chat Admin Sekarang
                        </a>
                    </div>
                </div>
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            <div
                ...
                <button onclick="closePreviewModal()"
                    class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 z-50 bg-white rounded-full p-1 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="bg-gray-100 p-8 flex items-center justify-center">
                        <img id="modalImage" src="" alt="Product Image"
                            class="w-full max-h-96 object-contain mix-blend-multiply">
                    ...
                    <div class="p-8 flex flex-col h-full">
                        <div class="mb-auto">
                            <h3 id="modalTitle" class="text-2xl font-black text-gray-900 leading-tight mb-2">Nama Produk
                            </h3>
                            ...
                            <div class="border-t border-b border-gray-100 py-4 mb-6">
                                <p id="modalDesc"
                                    class="text-gray-600 leading-relaxed text-sm h-24 overflow-y-auto pr-2">Deskripsi
                                    produk...</p>
                            </div>

                            <p class="text-sm font-bold text-gray-700 mb-2">Stok Tersedia: <span id="modalStock"
                            ...
                            <div class="flex items-center gap-4">
                                <div class="max-w-32">
                                    ...
                                    <div class="relative flex items-center">
                                        ...
                                        <input type="text" name="quantity" id="modalQty"
                                            class="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm font-bold block w-full py-2.5"
                                ...
                                <button type="submit" id="btnAddToCart"
                                    class="flex-1 text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-orange-300 font-bold rounded-lg text-sm px-5 py-3 text-center flex items-center justify-center gap-2 shadow-lg shadow-orange-200 transition">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z">
                                        </path>
                        ...
                        @else
                        <a href="{{ route('login') }}"
                            class="block w-full bg-gray-900 text-white text-center py-3 rounded-xl font-bold hover:bg-gray-800 transition">
                            Login untuk Membeli
                        </a>
                        @endauth
                    </div>
