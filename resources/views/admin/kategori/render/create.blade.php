        ...
        <div
            ...
            <form id="createKategoriForm" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama" placeholder="Contoh: Lakban, Bubble Wrap, Dus Karton, dll." class="w-full mt-1 px-4 py-2 bg-gray-50 border border-gray-300 rounded-xl
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3" placeholder="Deskripsi singkat kategori produk..."
