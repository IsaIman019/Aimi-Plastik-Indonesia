    ...
    <div class="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto h-screen">
        ...
        <div class="mb-6 lg:mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Manajemen Stok Produk</h1>
...
@push('scripts')
<script>
    window.STOK_INDEX_URL = "{{ route('admin.stok.index') }}";
</script>
<script src="{{ asset('assets/js/admin/stok/index.js') }}" defer></script>
@endpush
@endsection