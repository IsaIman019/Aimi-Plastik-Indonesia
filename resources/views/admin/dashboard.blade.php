    ...
    <div class="flex-1 p-4 md:p-8 overflow-y-auto h-screen">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                ...
                <p class="text-gray-500 mt-1">Halo Admin, ini ringkasan performa <span
                        class="text-orange-600 font-bold">Aimi Packaging</span> hari ini.</p>
            </div>

            <div class="flex flex-wrap gap-3">
                <a href="{{ route('admin.produk.create') }}"
                    class="flex items-center gap-2 bg-white border border-gray-200 text-gray-600 px-4 py-2 rounded-lg text-sm font-bold hover:bg-gray-50 transition shadow-sm">
                ...
                <a href="{{ route('admin.reports.index') }}"
                    class="flex items-center gap-2 bg-orange-600 text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-orange-700 transition shadow-lg shadow-orange-200">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div
                class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group hover:border-orange-200 transition">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-black text-gray-900 mt-1">Rp
                            {{ number_format($totalRevenue, 0, ',', '.') }}
                        </h3>
                        <div
                            class="flex items-center mt-2 text-xs font-bold text-green-600 bg-green-50 w-fit px-2 py-1 rounded-full">
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <div
                            class="flex items-center mt-2 text-xs font-bold text-orange-600 bg-orange-50 w-fit px-2 py-1 rounded-full">
                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                            </svg>
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-black text-gray-900 mt-1"></h3>
                        <div
                            class="flex items-center mt-2 text-xs font-bold text-gray-500 bg-gray-100 w-fit px-2 py-1 rounded-full">
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <div
                            class="flex items-center mt-2 text-xs font-bold text-purple-600 bg-purple-50 w-fit px-2 py-1 rounded-full">
                            Registered Users
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.orders') }}"
                        class="text-sm text-orange-600 hover:text-orange-700 font-bold">Lihat Semua</a>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-gray-400 mt-1">{{ $order->created_at->format('d M, H:i') }}
                                    </div>
                                </td>
                                <td class="px-6 py-4">
            ...
            <div class="flex flex-col gap-6">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-5">
                        @forelse($lowStockproduk as $product)
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center text-xs text-gray-500 overflow-hidden border border-gray-200">
                                    @if($product->image)
                        ...
                        <div class="w-full bg-gray-100 rounded-full h-1.5 -mt-2">
                            <div class="bg-red-500 h-1.5 rounded-full" style="width:min($product->stock * 10, 100)%">
                            </div>
                        </div>
                        @empty
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="{{ route('admin.artikel.index') }}"
                            class="text-xs text-orange-600 font-bold hover:underline">Kelola Berita →</a>
                    </div>
                    <p class="text-xs text-gray-500 mb-4">Kelola artikel berita untuk halaman depan website.</p>
                    <a href="{{ route('admin.artikel.create') }}"
                        class="block w-full text-center py-2 border-2 border-dashed border-gray-300 rounded-lg text-gray-500 hover:border-orange-500 hover:text-orange-500 font-bold text-sm transition">
                        + Tulis Artikel Baru
                    </a>
                </div>
