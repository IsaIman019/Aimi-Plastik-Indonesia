                ...
                <table id="pesananTable" class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-xs font-medium">NO PESANAN</th>
                            <th class="px-4 py-3 text-xs font-medium">NO RESI</th>
                            <th class="px-4 py-3 text-xs font-medium">TANGGAL PESANAN</th>
                            <th class="px-4 py-3 text-xs font-medium">TOTAL HARGA</th>
...
@push('scripts')
<script>
window.PESANAN_INDEX_URL = "{{ route('admin.pesanan.index') }}";
</script>
<script src="{{ asset('assets/js/admin/pesanan/index.js') }}" defer></script>
@endpush
@endsection
